...
/// <summary>
/// Component that you attach to all projectile prfabs. All spawned projectiles will fly in the direction 
...
public class Projectile : WeaponEffect
{
    ...
    {
        // Only drive moment ourselves if this is a kinematic
