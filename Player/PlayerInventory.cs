...
public class PlayerInventory : MonoBehaviour
{
    ...
    // Removes a weapon of a particlar type, as specified by <data>.
    ...
    // We also have an optinal boolean to remove this item from the upgrade list.
    ...
    // the slot number that item was put in.
    ...
    void ApplyUpgradeOptions()
    {
        ...
        // So we cant iterate through them in the function.
        ...
        foreach (UpgradeUI upgradeOption in upgradeUIOptions)
        {
            ...
            else
            {
                ...
                upgradeType = UnityEngine.Random.Range(1, 3); // Choose between weapon and passive items
            }
            ...
            if (upgradeType == 1)
            {
                ...
                if (chosenWeaponUpgrade != null)
                {
                    ...
                    // Loop through all our existing weapons. If we find a match, we will
                    ...
                    // If the code gets here, it means that will be adding a new weapon, instead of
    ...
    void RemoveUpgradeOptions()
    {
        foreach (UpgradeUI upgradeOption in upgradeUIOptions)
        {
            ...
            DisableUpgradeUI(upgradeOption);    // Call the DisableUpdateUI method here to disable all UI options before applying upgrades to them.
        }
    }
